...
>[!NOTE]
>CureCode is now online! Visit the following website: <a href="https://curecode.unige.net" target="_blank">curecode.unige.net</a>.
...
To try CureCode web application copy and paste in your browser navigation bar the url <a href="https://curecode.unige.net" target="_blank">curecode.unige.net</a>.
